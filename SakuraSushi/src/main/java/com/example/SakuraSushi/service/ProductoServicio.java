...
import com.example.SakuraSushi.domain.entity.General;
...
import com.example.SakuraSushi.domain.factory.ProductoFactory;
import com.example.SakuraSushi.dto.ComboDto;
import com.example.SakuraSushi.dto.GeneralDto;
...
public class ProductoServicio {
    ...
    private Producto convertDtoToEntity(ProductoDto dto) {
        ...
        } else if (entity instanceof General && dto instanceof GeneralDto) {
            General sashimiEntity = (General) entity;
            GeneralDto sashimiDto = (GeneralDto) dto;
            entity.setCategoria("Sashimi");
        } else {
    ...
    public ProductoDto convertEntityToDto(Producto entity) {
        ...
        } else if (entity instanceof General) {
            dto = new GeneralDto();
        }
